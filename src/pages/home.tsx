    ...
    return (
        <div className='h-screen'>
            <div className='w-full h-full flex flex-col items-center justify-start shadow-xl  bg-[#ffffff] min-h-screen'>
                <div className='fixed max-w-[377px] w-full h-full  md:max-w-[376px] '>
                ...
                {/* <div className='absolute flex  w-[375px] h-[50px] bottom-0 justify-between'>
                    ...
                    <button className='flex relative w-[80px] h-[55px] justify-center items-center'>
                        <div className='w-[80px] h-[55px] backdrop-blur-3xl opacity-[44%] drop-shadow-lg rounded-tr-lg border ' />
                        <img src="/image/Call.svg" alt="call" className='w-[20px] absolute' />
                    </button>


                    <button className='flex relative w-[200px] h-[55px] justify-center items-center'>
                    
                        <div className='w-[200px] h-[64px] backdrop-blur-3xl opacity-[44%] drop-shadow-lg rounded-t-lg border '/>
                    ...
                    <button className='flex relative w-[80px] h-[55px] justify-center items-center'>
                        <div className='w-[80px] h-[55px] backdrop-blur-3xl opacity-[44%] drop-shadow-lg rounded-tl-lg border ' />
